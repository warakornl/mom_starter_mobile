/**
 * EyeOffIcon — "hide password" affordance (password currently shown).
 * Shape: EyeIcon's almond outline + iris, with a diagonal slash through it.
...
export function EyeOffIcon({ color = 'currentColor', size = 24 }: Props): React.JSX.Element {
  return (
